      ...
      {token && (
        <div className="flex items-center gap-6">
          <Link to="/cart" className="relative">
            ...
            <div className="absolute -top-2 -right-2 bg-gray-300 text-primary-800 rounded-full w-5 h-5 flex items-center justify-center text-sm">
              {cartData?.numOfCartItems ?? <i className="fa-solid fa-spinner fa-spin"></i>}
            </div>
          </Link>
