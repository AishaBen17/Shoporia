...
export default function ProductCard({ productItem }) {
  ...
  return (
    <div className="relative p-2 pb-10 rounded-lg overflow-hidden col-span-6 sm:col-span-4 md:col-span-4 lg:col-span-3 xl:col-span-2 group transition-transform duration-300 hover:shadow-primary-300 hover:shadow-lg hover:scale-[1.02] flex flex-col">
    <Link to={`/product/${id}`} className="block">
      <div className="relative mb-1 w-full h-[250px] overflow-hidden flex justify-center items-center">
        <img
          src={imageCover}
    ...
    <div className="flex justify-between items-center">
      ...
      <div
        className={`cursor-pointer text-xl transition-all duration-300 hover:scale-110 hover:rotate-12 ${
          isInWishlist ? "text-danger-600" : "text-primary-300"
        }`}
        onClick={(e) => {
          e.stopPropagation();
